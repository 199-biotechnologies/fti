...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      // References
      h1("References"),
      p("[1] Legg, S.; Hutter, M. Universal intelligence: A definition of machine intelligence. Minds and Machines 2007, 17, 391\u2013444."),
      p("[2] Chollet, F. On the measure of intelligence. arXiv 2019, 1911.01547."),
      p("[3] Gignac, G.E.; Szodorai, E.T. Defining intelligence: Bridging the gap between human and artificial perspectives. Intelligence 2024, 104, 101832."),
      p("[4] Sternberg, R.J. What is intelligence, really? The futile search for a Holy Grail. Learning and Individual Differences 2024, 116, 102568."),
      p("[5] Friston, K. The free-energy principle: A unified brain theory? Nature Reviews Neuroscience 2010, 11, 127\u2013138."),
      p("[6] Ramstead, M.J.D. et al. On Bayesian mechanics: A physics of and by beliefs. Interface Focus 2023, 13, 20220029."),
      p("[7] Pezzulo, G.; Parr, T.; Friston, K. Active inference as a theory of sentient behavior. Biological Psychology 2024, 186, 108741."),
      p("[8] Pezzulo, G. et al. Generating meaning: Active inference and the scope and limits of passive AI. Trends in Cognitive Sciences 2024, 28, 97\u2013112."),
      p("[9] Landauer, R. Irreversibility and heat generation in the computing process. IBM Journal of Research and Development 1961, 5, 183\u2013191."),
      p("[10] Still, S. et al. Thermodynamics of prediction. Physical Review Letters 2012, 109, 120604."),
      p("[11] England, J.L. Dissipative adaptation in driven self-assembly. Nature Nanotechnology 2015, 10, 919\u2013923."),
      p("[12] Ali, A. et al. Predictive coding is a consequence of energy efficiency in recurrent neural networks. Patterns 2022, 3, 100639."),
      p("[13] Bialek, W.; Nemenman, I.; Tishby, N. Predictability, complexity, and learning. Neural Computation 2001, 13, 2409\u20132463."),
      p("[14] Crutchfield, J.P.; Young, K. Inferring statistical complexity. Physical Review Letters 1989, 63, 105\u2013108."),
      p("[15] Kolchinsky, A.; Wolpert, D.H. Semantic information, autonomous agency and non-equilibrium statistical physics. Interface Focus 2018, 8, 20180041."),
      p("[16] Tishby, N.; Pereira, F.C.; Bialek, W. The information bottleneck method. In Proceedings of the 37th Allerton Conference, 1999; pp. 368\u2013377."),
      p("[17] Klyubin, A.S.; Polani, D.; Nehaniv, C.L. All else being equal be empowered. In ECAL 2005; LNCS 3630; pp. 744\u2013753."),
      p("[18] Tiomkin, S. et al. Intrinsic motivation in dynamical control systems. PRX Life 2024, 2, 033009."),
      p("[19] Kiefer, A.B. Intrinsic motivation as constrained entropy maximization. Entropy 2025, 27, 372."),
      p("[20] Takahashi, K.; Hayashi, Y. Thermodynamic limits of physical intelligence. arXiv 2026, 2602.05463."),
      p("[21] Fagan, P.D. Toward a physical theory of intelligence. arXiv 2025, 2601.00021."),
      p("[22] Perrier, E. Watts-per-intelligence: Part I (energy efficiency). arXiv 2025, 2504.05328."),
      p("[23] Xu, J.; Li, Z. Information physics of intelligence: Unifying logical depth and entropy under thermodynamic constraints. arXiv 2025, 2511.19156."),
      p("[24] Han, J. Intelligence inertia: Physical principles and applications. arXiv 2026, 2603.22347."),
      p("[25] Saad-Falcon, J. et al. Intelligence per watt: Measuring intelligence efficiency of local AI. arXiv 2025, 2511.07885."),
    ]
  }]
});
